	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.ziliaobianhao" label="资料编号" prop="ziliaobianhao" >
					<el-input v-model="ruleForm.ziliaobianhao" placeholder="资料编号" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.ziliaoneirong" label="资料内容" prop="ziliaoneirong" >
				<span class="text">{{ruleForm.ziliaoneirong}}</span>
			</el-form-item>
			<el-form-item v-if="type!='info'"  label="资料详情" prop="ziliaoxiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
			...
			<el-form-item v-else-if="ruleForm.ziliaoxiangqing" label="资料详情" prop="ziliaoxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.ziliaoxiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.ziliaoxiangqing = this.ruleForm.ziliaoxiangqing.replace(reg,'../../../django9cq57jyc/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
