		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #fff","padding":"0","color":"#000","borderRadius":"10px","background":"#fff","borderWidth":"0px","width":"100%","fontSize":"14px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' prop="zuoyefujian" label="作业附件">
						<template slot-scope="scope">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('kehouzuoye','提交作业')" @click="tijiaozuoyeCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
