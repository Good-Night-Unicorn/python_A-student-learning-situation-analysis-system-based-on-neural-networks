<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="布置编号" prop="buzhibianhao" >
					<el-input v-model="ruleForm.buzhibianhao" placeholder="布置编号" clearable  :readonly="ro.buzhibianhao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="布置编号" prop="buzhibianhao" >
					<el-input v-model="ruleForm.buzhibianhao" placeholder="布置编号" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="提交内容" prop="tijiaoneirong" >
				<editor 
					...
					class="editor"
					myQuillEditor="tijiaoneirong"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.tijiaoneirong" label="提交内容" prop="tijiaoneirong" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.tijiaoneirong"></span>
			</el-form-item>
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						if(o=='buzhibianhao'){
							this.ruleForm.buzhibianhao = obj[o];
							this.ro.buzhibianhao = true;
							continue;
						}
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.tijiaoneirong = this.ruleForm.tijiaoneirong.replace(reg,'../../../django9cq57jyc/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
