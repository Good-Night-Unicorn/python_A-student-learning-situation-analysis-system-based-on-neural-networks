...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        #沙箱接口
        if tableName.lower()=="learningdata":
            urlpatterns.extend(
                  [
...
#预测
        if tableName.lower() == "learningdataforecast":
            urlpatterns.extend(
                       [
        ...
        if tableName.lower()=="xueshengchengji":
            urlpatterns.extend(
                  [
                  path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                       eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "xueshengchengji":
            urlpatterns.extend(
                [
                    path(r'{}/sectionStat/fenshu/kechengmingcheng'.format(tableName.lower()),
                         eval("{}_v.{}_sectionStat_fenshu_kechengmingcheng".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        ...
        if tableName.lower() == "discussxuexiziyuan":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
